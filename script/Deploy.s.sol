...
contract DeployScript is Script {
    ...
    function writeJsonAddresses() internal {
        ...
        osxAddresses = osxAddresses.serialize(
            "managementDaoMultisig",
            deployment.managementDaoMultisig
        );

        // ENS
        ensAddresses.serialize("ensRegistry", deployment.ensRegistry);
        ensAddresses.serialize(
            "daoSubdomainRegistrar",
            deployment.daoSubdomainRegistrar
        );
        ensAddresses.serialize(
            "pluginSubdomainRegistrar",
            deployment.pluginSubdomainRegistrar
        );
        ensAddresses = ensAddresses.serialize(
            "publicResolver",
        ...
        corePluginsAddresses = corePluginsAddresses.serialize(
            "stagedProposalProcessorPluginRepo",
            deployment.stagedProposalProcessorPluginRepo
        );
